...
export function DashboardPage() {
  ...
  const addExpense = async (newExpense: Omit<Expense, 'id'>) => {
    try {
      ...
      toast({
        title: 'Expense Added',
        description: `${newExpense.description} has been successfully added.`,
      });
    } catch (error) {
      toast({
        title: 'Error',
  ...
  const addGoal = async (newGoal: Omit<FinancialGoal, 'id' | 'currentAmount'>) => {
    try {
      ...
      toast({
        title: 'Goal Added',
        description: `${newGoal.name} has been successfully added.`,
      });
    } catch (error) {
       toast({
        title: 'Error',
    ...
    try {
      ...
      setGoals((prevGoals) =>
       ...
       toast({
        ...
        description: `Your contribution to the goal has been recorded.`,
      });
    } catch (error) {
       toast({
        title: 'Error',
