export function Background() {
  return (
    <div className="absolute inset-0 -z-10 h-full w-full bg-background">
      ...
      <div className="absolute -bottom-40 -left-20 h-80 w-80 rounded-full bg-[radial-gradient(circle_farthest-side,rgba(255,0,182,.15),rgba(255,255,255,0))]"></div>
      <div className="absolute -right-40 -top-40 h-80 w-80 rounded-full bg-[radial-gradient(circle_farthest-side,rgba(0,128,255,.15),rgba(255,255,255,0))]"></div>
      <div
